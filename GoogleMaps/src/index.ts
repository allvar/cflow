...
import { RenderGoogleMaps } from "./RenderGoogleMaps";
  ...
  implements ComponentFramework.ReactControl<IInputs, IOutputs>
{
  ...
  public updateView(
    ...
    console.log("GOOGLE MAPS, UPDATE:");
    return createElement(RenderGoogleMaps, {
      context,
      updatePosition: (position: string | undefined) => {
